...
TRIGGER:-P21D
ACTION:DISPLAY
DESCRIPTION:Recordatorio: confirmar RSVP (faltan 3 semanas)
END:VALARM
BEGIN:VALARM
TRIGGER:-P7D
ACTION:DISPLAY
DESCRIPTION:Recordatorio: confirmar RSVP (última semana)
END:VALARM
BEGIN:VALARM
TRIGGER:-PT1H
ACTION:DISPLAY
DESCRIPTION:Recordatorio: la boda empieza en 1 hora
END:VALARM
END:VEVENT
END:VCALENDAR`;
